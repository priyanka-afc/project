...
from user.views import userregister,userlogincheck,usernaivebayes,usernaivetest,usersvm,usersvmtest,rfanalyse,rftest,decesiontreeanalyze,decesiontreetest
